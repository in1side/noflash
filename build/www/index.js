...
var storageKey = 'noflash:cache'

function ignore(key, value) {
  if (!key || ['data', 'user', 'name', 'region', 'summoner', 'id'].includes(key)) { return value }
}

var Persist = function () { return ({
  actions: {
    __persistState: function (state, actions) {
      localStorage.setItem(storageKey, JSON.stringify(state, ignore))
    },

    __setState: function (state, actions, previousState) { return previousState; }
  },
  events: {
    loaded: function (state, actions) {
      var previousState = {}
      try {
        ...
        window.addEventListener('unload', function () { return actions.__persistState(); })
      }
    }
  }
}); }
...
var __moduleExports = shouldUseNative() ? Object.assign : function (target, source) {
	var arguments$1 = arguments;
...
var objectAssign = _interopDefault(__moduleExports);
...
var find = index.find;
var index_3 = index.has;
var update = index.update;
var set = index.set;
var apply = index.apply;
var $each = index.$each;
var index_8 = index.$eachKey;
var $eachPair = index.$eachPair;
var $apply = index.$apply;
var index_11 = index.$set;
var index_12 = index.$none;
var index_13 = index.$default;
var $merge = index.$merge;
var index_15 = index.$mergeDeep;
var index_16 = index.$begin;
var index_17 = index.$end;
var $pick = index.$pick;
var index_19 = index.$slice;
var index_20 = index.$first;
var index_21 = index.$last;
var index_22 = index.$setContext;
var index_23 = index.$pushContext;
var index_24 = index.$nav;
var index_25 = index.$lens;
var index_26 = index.$traverse;
var index_27 = index.isReduced;
...
var data$1 = {
  fetch: function (state, actions, user) { return (
  ...
  user: {
    setName: function (state, actions, name) { return (
      update(['data', 'user', ['name', index_11(name)], ['summoner', index_11(null)]], state)
    ); },

    setRegion: function (state, actions, region) { return (
      update(['data', 'user', ['region', index_11(region)], ['summoner', index_11(null)]], state)
    ); },

    setSummoner: function (state, actions, summoner) { return (
...
var __moduleExports$1 = attributeToProperty
...
var index$2 = function (h, opts) {
  if (!opts) { opts = {} }
  var concat = opts.concat || function (a, b) {
    return String(a) + String(b)
  }
  if (opts.attrToProp !== false) {
    h = __moduleExports$1(h)
  }
...
var html = index$2(h, { attrToProp: false })
...
var classVariants = function (ref) {
  ...
  return index$3(( obj = {}, obj["-loading"] = loading, obj ))
  var obj;;
}
...
var classVariants$2 = function (spell, timer) { return index$3(( obj = {
